...
class YOLODetector(BaseDetector):
    ...
    def image_preprocess(self, img_source):
        """
        Pre-process the img before fed to the object dectection network
    ...
    def images_detection(self, imgs, orig_dim_list):
        """
        Feed the img data into object dectection network and
        ...
        Output: dets(torch.cuda.FloatTensor,(n,(batch_idx,x1,y1,x2,y2,c,s,idx of cls))): object dectection results
        """
        args = self.detector_opt
        _CUDA = True
        if args:
        ...
        with torch.no_grad():
            ...
            #do nms to the dectection results, only human category is left
    ...
    def write_results(self, prediction, confidence, num_classes, nms=True, nms_conf=0.4):
        ...
        for ind in range(batch_size):
            ...
            for cls in img_classes:
                ...
                if nms:
                    if platform.system() != 'Windows':
                        ...
                        while image_pred_class.size(0):
                            # Get dectection with highest confidence and save as max dectection
                            max_detections.append(image_pred_class[0].unsqueeze(0))
                            # Stop if we're at the last dectection
                ...
                #Concatenate the batch_id of the image to the dectection
                #this helps us identify which image does the dectection correspond to
