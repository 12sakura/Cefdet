...
def non_max_suppression(boxlist,
  ...
  Args:
    boxlist: BoxList holding N boxes.  Must contain a 'scores' field
      representing dectection scores. All scores belong to the same class.
...
def multi_class_non_max_suppression(boxlist, score_thresh, iou_thresh,
  ...
  Args:
    boxlist: BoxList holding N boxes.  Must contain a 'scores' field
      representing dectection scores.  This scores field is a tensor that can
...
def filter_scores_greater_than(boxlist, thresh):
  ...
  Args:
    boxlist: BoxList holding N boxes.  Must contain a 'scores' field
      representing dectection scores.
