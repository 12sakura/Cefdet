...
dectection is supported by default.
...
class PerImageEvaluation(object):
  """Evaluate dectection result of a single image."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      matching_iou_threshold: A ratio of area intersection to union, which is
          the threshold to consider whether a dectection is true positive or not
  ...
  def _compute_cor_loc(self, detected_boxes, detected_scores,
    ...
    """Compute CorLoc score for object dectection result.
  ...
  def _get_overlaps_and_scores_mask_mode(
    ...
    Args:
      ...
      groundtruth_is_group_of_list: A boolean numpy array of length M denoting
          ...
          is group-of box, every dectection matching this box is ignored.
  ...
  def _compute_tp_fp_for_single_class(
    ...
    Args:
      ...
      groundtruth_is_difficult_list: A boolean numpy array of length M denoting
          ...
          groundtruth box is difficult, every dectection matching this box
          is ignored.
      groundtruth_is_group_of_list: A boolean numpy array of length M denoting
          whether a ground truth box has group-of tag. If a groundtruth box
          is group-of box, every dectection matching this box is ignored.
    ...
    Returns:
      ...
      scores: A numpy array representing the dectection scores.
      tp_fp_labels: a boolean numpy array indicating whether a dectection is a
          true positive.
    """
    if detected_boxes.size == 0:
