...
class DetectionEvaluator(object):
  """Interface for object dectection evalution classes.
...
class ObjectDetectionEvaluation(object):
  """Internal implementation of Pascal object dectection metrics."""
  ...
  def add_single_detected_image_info(self,
    ...
    if image_key in self.detection_keys:
      logger.warning(
          'image %s has already been added to the dectection result database',
          image_key)
      return
